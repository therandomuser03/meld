...
export function PersonCard({ user, status = "NONE", currentUserId }: PersonCardProps) {
    ...
    return (
        <div className="group bg-slate-900/50 border border-white/10 hover:border-blue-500/30 p-6 rounded-2xl flex flex-col items-center text-center transition-all">
            ...
            <p className="text-xs text-slate-400 line-clamp-2 mb-4 h-8 px-2">
                {user.bio || "Building things with code and coffee."}
            </p>

            <div className="flex items-center gap-1.5 text-[10px] text-slate-500 mb-6 bg-white/5 px-3 py-1 rounded-full border border-white/5">
